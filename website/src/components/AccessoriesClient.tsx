          ...
          {accessories.map((accessory, i) => (
            ...
            >
              ...
              <button
                onClick={() => {
                  addItem({
                    id: `accessory-${toSlug(accessory.name)}`,
                ...
                className="mt-6 btn-glass-secondary inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl text-sm font-semibold text-paper border border-gold/20 hover:border-gold/40"
              >
                <ShoppingBag size={16} />
                Thêm vào giỏ hàng
              </button>
