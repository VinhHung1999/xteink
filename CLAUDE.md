...
This is **not a software project** — there is no build system, no tests, no linting. The only executable is `download_images.sh` (downloads product images from xteink.com).
